...
import type { IconMode, TelemetryConfig } from "../../shared/config.js";
import { getConfig } from "../../shared/pi-tui-store.js";
import { resolveGlyphs } from "../../shared/icons.js";
import { fmtTokens, formatDuration } from "../../shared/utils.js";
...
export default function piTelemetry(pi: ExtensionAPI): void {
	...
	pi.on("agent_settled", (event, ctx) => {
		const telemetry = tracker.handle(event);
